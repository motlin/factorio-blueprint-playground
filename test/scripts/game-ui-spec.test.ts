...
describe('generated game UI specification', () => {
	...
	it('contains representative Factorio 2.1.12 UI facts', () => {
		expect({
			...
			styles: {
				blueprintRecordSlotPadding: 4,
				blueprintRecordSlotSize: 80,
				defaultTableHorizontalSpacing: 4,
				defaultTableVerticalSpacing: 4,
				slotSize: 40,
				...
				buttonMinimalHeight: 28,
				buttonMinimalWidth: 108,
				draggableSpaceHeaderLeftMargin: 4,
				frameActionButtonSize: 24,
				framePaddingBottom: 8,
				framePaddingLeft: 8,
				framePaddingRight: 8,
				framePaddingTop: 4,
				frameTitleFontSize: 18,
				headerFillerHeight: 24,
				scrollbarThumbWidth: 10,
				scrollbarWidth: 12,
				tooltipFrameOpacity: 0.88,
				tooltipLabelMaximalWidth: 356,
				tooltipLabelMinimalWidth: 50,
				bindings: {
