...
import { DeconstructionPlannerPanel } from '../../src/components/BlueprintInfoPanels';
...
function replaceIconUrls(html: string): string {
    return html.replace(/https:\/\/factorio-icon-cdn\.pages\.dev\/[^"]+/g,
...
describe('Visual regression tests', () => {
    ...
    it(
        'BlueprintTree renders consistently',
        async () => {
            const mockBlueprint = {
                blueprint_book: {
                    item: 'blueprint-book',
