...
vi.mock('../../src/components/ui', () => ({
  ...
  InsetDark: ({children, style, onClick, ...props}: {children: React.ReactNode; style?: React.CSSProperties; onClick?: () => void; [key: string]: unknown}) => (
    <div data-testid="inset-dark" style={style} onClick={onClick} {...props}>
      {children}
    </div>
  ),
  Button: ({children, onClick, disabled, style, ...props}: {children: React.ReactNode; onClick?: () => void; disabled?: boolean; style?: React.CSSProperties; [key: string]: unknown}) => (
    <button
      data-testid="button"
      onClick={onClick}
      disabled={disabled}
  ...
  ButtonGreen: ({children, onClick, disabled, style}: {children: React.ReactNode; onClick?: () => void; disabled?: boolean; style?: React.CSSProperties}) => (
