...
const ParameterRow = ({ param, parameters }: ParameterRowProps) => {
    ...
    const iconInfo: SignalID | null = param.type === 'id' && param.id
    ...
    function getIngredientOfElement() {
        ...
        return (
            <div className="flex flex-items-center">
                <label className="mr2" htmlFor={'ingredientOf'}>Ingredient of:</label>
    ...
    return (
        <div className="flex flex-items-center p4" style={{ minHeight: '48px' }}>
            ...
            <div className="flex flex-items-center mr8" style={{ minWidth: '200px' }}>
                <label className="mr2" htmlFor={'name'}>Name:</label>
                <input
                    id={'name'}
                    type="text"
                    value={param.name}
            ...
            <div className="flex flex-items-center mr8" style={{ minWidth: '120px' }}>
                <label className="mr2" htmlFor={'value'}>Value:</label>
                {getValueElement()}
            </div>
            ...
            {param.type === 'number' ? (
                <>
                    <div className="flex flex-items-center mr8" style={{ minWidth: '200px' }}>
                        <label className="mr2" htmlFor={'variable'}>Variable:</label>
                        <input
                            type="text"
                    ...
                    <div className="flex flex-items-center" style={{ minWidth: '240px' }}>
                        <input
                            ...
                            className="mr2"
                        />
                        <label className="mr2" htmlFor={'formula'}>Formula:</label>
                        <input
                            type="text"
                            value={param.formula ?? ''}
                            style={{ width: '140px' }}
